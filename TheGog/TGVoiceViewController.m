...
@interface TGVoiceViewController ()<UITableViewDataSource,UITableViewDelegate>
{
    NSInteger _num;
...
-(void)CreatUI
{
    ...
    NSArray*btntitles=@[@"活动报道",@"达人志",@"专栏"];
    for (int i = 0; i < 3; i++)
    {
        UIButton *button = [UIButton buttonWithType:UIButtonTypeCustom];
        button.frame = CGRectMake(i*width+60, 0, width-20, 39);
    ...
    UIView*view=[[UIView alloc]initWithFrame:CGRectMake(width+60, 0, width-20, 39)];
