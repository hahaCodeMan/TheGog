...
@interface TrainThreeViewController ()<UIWebViewDelegate,UMSocialUIDelegate>
{
...
-(void)creatNavgationBar
{
    ...
    //[button setImage:[UIImage imageNamed:@"返回_1.png"] forState:UIControlStateNormal];
    ...
    switch (button.tag)
    {
        case 101:
        {
            ...
            [UMSocialSnsService presentSnsIconSheetView:self appKey:@"507fcab25270157b37000010"
                                        ...
                                        shareToSnsNames:@[UMShareToSina,UMShareToTencent,UMShareToEmail,UMShareToRenren,UMShareToWechatTimeline]
                                               delegate:self];
...
-(void)webViewData
{
    ...
    //NSLog(@"+++%@",self.id);
    //转化成NSURL
   _WebUrl= [NSURL URLWithString:_Path];
    //将URL封装成request对象
